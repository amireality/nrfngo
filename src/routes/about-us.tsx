...
const AWARDS = [
  ...
  { year: "2022", title: "UNICEF Partner of the Year (India)" },
...
export const Route = createFileRoute("/about-us")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meet the team behind Northrop Research Foundation — a Maharashtra-founded NGO for children with special needs." },
    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="bg-brand-light px-6 md:px-[110px] py-[100px] flex flex-col lg:flex-row justify-between gap-[48px]">
        ...
        <p className="max-w-[480px] text-ink-muted text-[16px] leading-[1.7]">
          Northrop Research Foundation was founded in 2016 in Maharashtra, India. What started as a weekend visit
      ...
      <section className="px-6 md:px-[110px] py-[100px] flex flex-col lg:flex-row gap-[48px] items-center">
        ...
        <div className="flex-1 max-w-[640px]">
          ...
          <p className="text-ink-muted text-[16px] leading-[1.7] mt-[24px]">
            I started Northrop Research Foundation after my nephew Aarav was diagnosed with autism at four. What I
