  ...
  return (
    ...
    >
      <Link to="/" className="flex flex-col leading-none">
        <span className="font-bold text-[18px] md:text-[20px] text-ink tracking-tight">Northrop Research</span>
        <span className="font-script text-[22px] md:text-[24px] text-brand-dark -mt-1 self-end">Foundation</span>
      </Link>
